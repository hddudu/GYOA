package org.apache.struts2.views.jsp.uii;
...
//	    		pageContext.getOut().write(cbuf);//可以直接向页面输出东西
//	    		return EVAL_PAGE;//如果没有标签，就不显示当前<a>标签,只是继续执行页面中后面的代码
		}
