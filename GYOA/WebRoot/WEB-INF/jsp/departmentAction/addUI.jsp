                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">上级部门</td>
                        <td>
                            ...
                            <!-- departmentId必须也是model的一部分 -->
                            <s:select name="parentId" list="#departmentList"  cssClass="SelectStyle"
                    ...
                    <tr><td>职能说明</td>
                        <td><s:textarea name="deptDesc" cssClass="TextareaStyle"></s:textarea></td>
                    </tr>
                </table>
            </div>
        </div>
